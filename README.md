...
The application integrates several essential modules — **real-time notifications**, **online donations**, and an **AI component** capable of recognizing a cat’s breed from an uploaded image.  
...
This project was built using **Laravel (PHP framework)**, with a focus on modular development inspired by **Scrum methodology**, organizing implementation into clear, iterative stages.
