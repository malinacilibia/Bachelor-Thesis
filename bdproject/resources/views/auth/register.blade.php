    ...
    <div class="login-wrapper">
        <div class="login-left">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <input id="name" type="text" name="name" class="@error('name') is-invalid @enderror" value="{{ old('name') }}" required autofocus>
                @error('name')
                ...
                <button type="submit" class="login-button">Creează cont</button>
            </form>

            <p class="new-user">Ai deja un cont? <a href="{{ route('login') }}">Autentifică-te</a></p>
        </div>

        <div class="login-right">
            <img src="{{ asset('images/login.png') }}" alt="Imagine pisică">
        </div>
    </div>
@endsection
<style>
